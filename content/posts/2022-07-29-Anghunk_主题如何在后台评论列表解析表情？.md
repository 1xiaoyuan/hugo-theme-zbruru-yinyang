...
date: 2022-07-29 20:11:00
updated: 2022-07-29 23:53:03
author: 
categories: 
  - 技术
tags: 
...
function getparseBiaoQingComment($content) {
	...
	global $emo;
	if(!$emo) {
		$emo = json_decode(file_get_contents(dirname(dirname(dirname(__FILE__))).'/zburu.com/usr/themes/Anghunk/OwO.json'), true);
	}
	foreach ($emo as $v) {
		if($v['type'] == 'image') {
